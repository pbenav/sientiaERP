...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Setting::set('pdf_footer_text', 'sienteERP System | Sientia SL | Registro Mercantil de Madrid, Tomo 12345, Folio 123, Sección 8, Hoja M-123456', 'Pie de página PDF', 'Documentos');
