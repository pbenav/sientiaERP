...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Setting::set('default_tax_rate', 21, 'IVA por Defecto (%)', 'Impuestos');
        \App\Models\Setting::set('default_supplier_id', null, 'Proveedor por Defecto (OCR)', 'Compras');
        ...
        \App\Models\Setting::set('pdf_footer_text', 'sientiaERP System | Sientia SL | Registro Mercantil de Madrid, Tomo 12345, Folio 123, Sección 8, Hoja M-123456', 'Pie de página PDF', 'Documentos');
