            ...
            ->schema([
                Forms\Components\Tabs::make('Tabs')
                    ->tabs([
                        ...
                        Forms\Components\Tabs\Tab::make('Contacto y Dirección')
                        ...
                        Forms\Components\Tabs\Tab::make('Facturación y Pago')
                        ...
                        Forms\Components\Tabs\Tab::make('Factura Electrónica (DIR3)')
                            ->icon('heroicon-o-building-office')
                            ->schema([
                                Forms\Components\Section::make('Centros Administrativos (DIR3)')
                                    ->description('Códigos obligatorios para el envío a la Administración Pública (FACe).')
                                    ->schema([
                                        Forms\Components\TextInput::make('dir3_oficina_contable')
                                            ->label('Oficina Contable (01)')
                                            ->placeholder('Ej: L01080197')
                                            ->maxLength(15),
                                        Forms\Components\TextInput::make('dir3_organo_gestor')
                                            ->label('Órgano Gestor (02)')
                                            ->placeholder('Ej: L01080197')
                                            ->maxLength(15),
                                        Forms\Components\TextInput::make('dir3_unidad_tramitadora')
                                            ->label('Unidad Tramitadora (03)')
                                            ->placeholder('Ej: L01080197')
                                            ->maxLength(15),
                                    ])->columns(3),
                            ]),
