        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('debug_verifactu')
                    ...
                    ->modalContent(fn ($record) => new \Illuminate\Support\HtmlString(\Illuminate\Support\Facades\Blade::render("@livewire('verifactu-debugger', ['recordId' => {$record->id}, 'modelClass' => '" . get_class($record) . "'])")))
