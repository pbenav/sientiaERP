...
use App\SientiaErpTui\Display\ListController;
use App\SientiaErpTui\Display\FormController;
    ...
    public function editar(int $id): void
    {
        try {
            ...
            while (true) {
                ...
                $key = \App\SientiaErpTui\Input\FunctionKeyMapper::mapKey($rawKey);
                ...
                // Editar líneas
                    ...
                    // Añadir línea
                    elseif ($key === 'F5') {
                        $lineModal = new \App\SientiaErpTui\Display\LineItemModal($this->keyHandler, $this->screen);
