...
```
╔══════════════════════════════════════════════════════════════╗
║ sientiaERP              GESTIÓN DE TERCEROS      13/01/2026 00:40║
╠══════════════════════════════════════════════════════════════╣
...
- [ ] Actualizar `sientiaerp-tui-menu.php`
...
### **Ejemplo Básico:**
```php
use App\SientiaErpTui\Display\FullScreenLayout;
use App\SientiaErpTui\Display\ColorTheme;
...
Esto implicará:
1. Modificar `sientiaerp-tui-menu.php` para usar `FullScreenLayout`
