# Inicio Rápido - Cliente TUI sientiaERP
...
```bash
# En una terminal
cd /home/pablo/Desarrollo/Laravel/sientiaERP
php artisan serve
```
...
1. **Modo Desarrollo**: El login es automático. Para producción, cambia `$devMode = false` en `bin/sientiaerp-tui.php`
