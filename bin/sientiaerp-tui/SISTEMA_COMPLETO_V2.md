...
- **Empresa (sientiaERP)**: Cyan brillante
...
```
╔══════════════════════════════════════════════════════════════════════════════╗
║ sientiaERP (cyan)          MENÚ PRINCIPAL (blanco)          13/01/2026 00:42 (cyan)║
╠══════════════════════════════════════════════════════════════════════════════╣
...
### **Cambiar Tema:**
Edita `sientiaerp-tui-menu.php` línea 96:
```php
