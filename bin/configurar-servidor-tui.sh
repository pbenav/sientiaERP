#!/bin/bash
# Script de configuración del servidor TUI de sienteERP

echo "╔═══════════════════════════════════════════════════════════╗"
echo "║     Configuración del Servidor TUI de sienteERP          ║"
echo "╚═══════════════════════════════════════════════════════════╝"
echo ""
...
# Configuracion del Cliente TUI de sienteERP
...
echo "  php bin/sienteerp-tui.php"
echo ""
