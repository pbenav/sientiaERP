...
- **Empresa (sienteERP)**: Cyan brillante
...
```
╔══════════════════════════════════════════════════════════════════════════════╗
║ sienteERP (cyan)          MENÚ PRINCIPAL (blanco)          13/01/2026 00:42 (cyan)║
╠══════════════════════════════════════════════════════════════════════════════╣
...
### **Cambiar Tema:**
Edita `sienteerp-tui-menu.php` línea 96:
```php
