# Inicio Rápido - Cliente TUI nexERP
...
1. **Modo Desarrollo**: El login es automático. Para producción, cambia `$devMode = false` en `bin/nexerp-tui.php`
