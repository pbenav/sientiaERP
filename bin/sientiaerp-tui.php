...
use App\SientiaErpTui\Display\MainMenu;
use App\SientiaErpTui\Input\KeyHandler;
use App\SientiaErpTui\ErpClient;
use App\SientiaErpTui\Actions\TercerosActions;
use App\SientiaErpTui\Actions\DocumentosActions;
use App\SientiaErpTui\Actions\AlmacenActions;
use App\SientiaErpTui\Actions\DetailsActions;
...
try {
    ...
    if ($devMode) {
        ...
        echo "\n\n";
        echo "  ╔═══════════════════════════════════════╗\n";
        echo "  ║     SISTEMA sientiaERP - AUTENTICACIÓN    ║\n";
        echo "  ╚═══════════════════════════════════════╝\n\n";
    ...
    $menu = new MainMenu($keyHandler, $screen, $menuStructure, \App\SientiaErpTui\Display\ColorTheme::IBM_GREEN);
