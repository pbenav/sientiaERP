...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <body class="bg-slate-950 text-white min-h-screen flex flex-col">
        ...
        <!-- Footer -->
        <footer class="relative z-10 border-t border-white/5 py-12 px-6 bg-slate-950/50 backdrop-blur-lg mt-auto font-medium">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-500">
                <div class="flex items-center gap-2">
                    <span class="text-xl font-bold tracking-tight text-white mr-4">siente<span class="text-blue-400">ERP</span></span>
                    <span class="font-bold">© {{ date('Y') }} <a href="https://www.sientia.com" class="hover:underline hover:text-blue-400 text-slate-400 transition-colors">Sientia</a></span>
                    <span class="mx-1">|</span>
                    <span>v{{ config('app.version', '2.0.0') }}</span>
                    <span class="mx-1">|</span>
                    <a href="https://www.gnu.org/licenses/agpl-3.0.txt" target="_blank"
                        class="hover:text-blue-400 transition-colors">Licencia AGPL v3</a>
                </div>
                
                <div class="flex items-center space-x-6">
                    <!-- Open Source Links -->
                    <div class="flex items-center gap-3 border-r border-white/10 pr-4 mr-2">
                        <a href="https://github.com/pbenav" target="_blank" title="GitHub" class="hover:text-white transition-colors">
                        ...
                        <a href="https://gitlab.com/pbenav" target="_blank" title="GitLab" class="hover:text-white transition-colors">
                    ...
                    <div class="flex items-center gap-5">
                        <a href="https://www.patreon.com/cw/sientia" target="_blank"
                            class="text-orange-500 hover:text-orange-400 font-bold transition-colors flex items-center gap-1.5 group">
                            <i class="fab fa-patreon group-hover:scale-110 transition-transform"></i>
                            Patreon
                        </a>
                        <span class="text-white/10 mx-1">|</span>
                        <a href="https://buymeacoffee.com/sientia" target="_blank"
                            class="text-yellow-500 hover:text-yellow-400 font-bold transition-colors flex items-center gap-1.5 group">
