                ...
                <div class="flex items-center gap-4">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <span
                                class="text-[10px] uppercase font-bold text-gray-300">{{ auth()->user()->name }}</span>
                        </div>
                        ...
                        <div class="flex flex-col bg-white p-3 rounded-lg border border-gray-300 shadow-sm">
                            ...
                            @if ($payment_method === 'mixed')
                                <div class="grid grid-cols-2 gap-2">
                                    <div class="flex flex-col">
                                        <span
                                            class="text-[9px] font-bold text-green-600 uppercase mb-0.5">Efectivo</span>
                                    ...
                                    <div class="flex flex-col">
                                        <span
                                            class="text-[9px] font-bold text-blue-600 uppercase mb-0.5">Tarjeta</span>
