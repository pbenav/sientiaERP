    ...
    <div class="space-y-1">
        ...
        @if($showDataForm)
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-1 space-y-1">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 ocr-table">
                                <thead class="bg-gray-50 dark:bg-gray-900">
                                    <tr>
                                        ...
                                        <th class="px-1 py-0 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-24">Ref/SKU</th>
                                        <th class="px-1 py-0 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Descripción</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-16">Cant.</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-24">P. Compra</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-16">Dto % (%)</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-20">Marg %</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-24">Beneficio</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-20">IVA</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-24">P. Venta</th>
                                        <th class="px-1 py-0 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-32">Imp. total</th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                                    @foreach($parsedData['items'] as $index => $item)
                                        <tr x-data="{
                                            ...
                                            <td class="px-1 py-0">
                                                <input type="text" wire:model="parsedData.items.{{ $index }}.reference" onfocus="this.select()" class="block w-full text-xs rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white {{ $displayUppercase ? 'uppercase-display' : '' }}" placeholder="REF">
                                            </td>
                                            <td class="px-1 py-0">
                                                <input type="text" wire:model="parsedData.items.{{ $index }}.description" onfocus="this.select()" class="block w-full text-xs rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white {{ $displayUppercase ? 'uppercase-display' : '' }}">
                                            </td>
                                            <td class="px-1 py-0">
                                                <input 
                                                    type="number" 
                ...
                <div class="p-1 bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800 rounded-lg flex flex-col md:flex-row md:items-center gap-1">
                    <div class="flex items-center gap-1">
                        ...
                        <label for="generateLabels" class="text-xs font-medium text-gray-700 dark:text-gray-300">Generar documento de etiquetas también</label>
                    </div>

                    @if($generateLabels)
                        <div class="flex-1 max-w-xs">
                            <select wire:model="selectedLabelFormatId" class="block w-full text-xs rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
